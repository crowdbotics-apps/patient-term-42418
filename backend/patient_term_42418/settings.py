"""
Django settings for patient_term_42418 project.
...
ROOT_URLCONF = 'patient_term_42418.urls'
...
WSGI_APPLICATION = 'patient_term_42418.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_term_42418 API",
    "DESCRIPTION": "API documentation for patient_term_42418 App",
    "VERSION": "v1",
}
